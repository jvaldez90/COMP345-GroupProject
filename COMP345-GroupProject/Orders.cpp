...
bool Deploy::validate() {
    ...
    if (this->target->getPlayer() == this->getPlayer()) {
...
bool Advance::validate() {
    ...
    if (this->source->getPlayer() != this->getPlayer()) {
...
//String to log method to print to file
string Deploy::stringToLog() const {
    return "Deploy order has been called";
}
...
bool Advance::execute() {
    ...
    if (this->validate() == true) {
        ...
        if (this->source->getPlayer() == this->getPlayer() && this->target->getPlayer() == this->getPlayer()) {
...
bool Bomb::validate() {
    ...
    if (this->target->getPlayer() == this->getPlayer()) {
        ...
        for (Territory* adjacent_territory : this->target->get_neighbour_territory()) {
            if (adjacent_territory->getPlayer() == this->getPlayer()) {
                cout << "Order validated";
                return true;
            }
        }
...
bool Airlift::validate() {
    ...
    else if (this->target->getPlayer() != this->getPlayer()) {
        cout << "Invalid order : Target does not belong to player" << endl;
        return false;
    }
    cout << "Order validated" << endl;
