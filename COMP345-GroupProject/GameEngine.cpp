...
std::ostream &operator<<(std::ostream &cout, GameEngine::GameCommands gc)
{
    switch (gc)
    {
    case GameEngine::LOADMAP:
        cout << "loadmap";
        break;
    case GameEngine::VALIDATEMAP:
        cout << "validatemap";
        break;
    case GameEngine::ADDPLAYER:
        cout << "addplayer";
        break;
    case GameEngine::GAMESTART:
        cout << "gamestart";
        break;
    case GameEngine::REPLAY:
        cout << "replay";
        break;
    case GameEngine::QUIT:
        cout << "quit";
        break;
    case GameEngine::ISSUEORDER:
        cout << "issueorder";
        break;
    case GameEngine::ENDISSUEORDERS:
        cout << "endissueorders";
        break;
    case GameEngine::EXEORDER:
        cout << "exeorder";
        break;
    case GameEngine::ENDEXEORDERS:
        cout << "endexeorders";
        break;
    case GameEngine::PLAY:
        cout << "play";
        break;
    case GameEngine::TOURNAMENT:
        cout << "tournament";
        break;
    default:
...
std::ostream &operator<<(std::ostream &cout, GameEngine::GameStates gs)
{
    ...
    case GameEngine::START:
        cout << "start";
        break;
    case GameEngine::MAPLOADED:
        cout << "maploaded";
        break;
    case GameEngine::MAPVALIDATED:
        cout << "mapvalidate";
        break;
    case GameEngine::PLAYERSADDED:
        cout << "playersadded";
        break;
    case GameEngine::ASSIGNREINFORCEMENT:
...
void GameEngine::Tournament(std::vector<Map *> M, std::vector<Player *> P, int G, int D)
{
    ...
    */
    ...
    for (int mapCounter = 0; mapCounter < M.size(); mapCounter++)
    { // FOR-LOOP for each map loaded
